...
void ButtonLayout_Init(button_layout_t* button_layout) {
    ...
    Button_InitVec2(&button_layout->buttons[0], (vec2_t){SCREEN_WIDTH / 2, 20}, (vec2_t){100, 25}, C2D_Color32f(1.f, 0.f, 0.f, 1.f), true);
    Button_InitVec2(&button_layout->buttons[1], (vec2_t){SCREEN_WIDTH / 2, 70}, (vec2_t){100, 25}, C2D_Color32f(0.f, 1.f, 0.f, 1.f), false);
    Button_InitVec2(&button_layout->buttons[2], (vec2_t){SCREEN_WIDTH / 2, 120}, (vec2_t){100, 25}, C2D_Color32f(0.f, 0.f, 1.f, 1.f), true);

    button_layout->buttons[0].on_pressed = Button_TestButton;
