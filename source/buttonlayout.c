...
void ButtonLayout_Init(button_layout_t* button_layout) {
    ...
    // Test buttons
    Button_InitVec2(&button_layout->buttons[1], (vec2_t){200, 20}, (vec2_t){96, 32}, C2D_Color32f(1.f, 0.f, 0.f, 1.f), true);
    Button_InitVec2(&button_layout->buttons[2], (vec2_t){200, 60}, (vec2_t){96, 32}, C2D_Color32f(0.f, 1.f, 0.f, 1.f), true);
    Button_InitVec2(&button_layout->buttons[3], (vec2_t){200, 100}, (vec2_t){96, 32}, C2D_Color32f(0.f, 0.f, 1.f, 1.f), true);
